...
public class Author2 implements Comparable<Author2> {
	...
	private final SortingKey2 a_sortingKey;
	private final ArrayList<Article2> a_articles;
	 ...
	 *
	 */
	static public class SortingKey2 implements Comparable<SortingKey2> {
		...
		@Override
		public int compareTo(final SortingKey2 o) {
	...
	public Author2(
		...
		a_sortingKey = new SortingKey2(namePrefix, firstName, middleName, lastName, nameSuffix, givenName);
		a_articles = new ArrayList<Article2>();
	 ...
	 * @return sorting key
	 */
	public SortingKey2 getSortingKey() {
		return a_sortingKey;
	}
	 ...
	 * @param article
	 */
	public void addArticle(final Article2 article) {
	...
	public Article2[] getArticles() {
		return a_articles.toArray(new Article2[0]);
	}
    ...
    public Link2[] getLinks() {
        return a_links.toArray(new Link2[0]);
    }
    

	@Override
	public int compareTo(final Author2 o) {
