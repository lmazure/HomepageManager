...
class LinkDataExtractorTest {
    ...
    */
    ...
    @Test
    void numberphilePodcastIsManaged() throws ContentParserException {
        final String url = "https://www.numberphile.com/podcast/2018/11/21/fermats-last-theorem-with-ken-ribet";
        final String expectedXml = """
                ...
                <DATE><YEAR>2018</YEAR><MONTH>11</MONTH><DAY>22</DAY></DATE>\
                <COMMENT>XXXXX</COMMENT></ARTICLE>""";
        final LinkDataExtractor extractor = getExtractor(url);
        Assertions.assertEquals(expectedXml, generateSureXml(extractor));
        Assertions.assertTrue(extractor.getProbableAuthors().isEmpty());
    ...
    void oxideAndFriendsIsManaged() throws ContentParserException {
        final String url = "https://oxide-and-friends.transistor.fm/episodes/unshrouding-turin-or-benvenuto-a-torino";
        final String expectedXml = """
                <ARTICLE><X><T>Unshrouding Turin (or Benvenuto a Torino)</T>\
                <A>https://oxide-and-friends.transistor.fm/episodes/unshrouding-turin-or-benvenuto-a-torino</A>\
                <L>en</L><F>MP3</F><DURATION><HOUR>1</HOUR><MINUTE>53</MINUTE><SECOND>36</SECOND></DURATION>\
                ...
                <AUTHOR><FIRSTNAME>Robert</FIRSTNAME><LASTNAME>Mustacchi</LASTNAME></AUTHOR>\
                <AUTHOR><FIRSTNAME>Adam</FIRSTNAME><LASTNAME>Leventhal</LASTNAME></AUTHOR>\
                <AUTHOR><FIRSTNAME>Eric</FIRSTNAME><LASTNAME>Aasen</LASTNAME></AUTHOR>\
                <AUTHOR><FIRSTNAME>Nathaneal</FIRSTNAME><LASTNAME>Huffman</LASTNAME></AUTHOR>\
                <DATE><YEAR>2024</YEAR><MONTH>10</MONTH><DAY>14</DAY></DATE>\
                <COMMENT>XXXXX</COMMENT></ARTICLE>""";
        final LinkDataExtractor extractor = getExtractor(url);
        Assertions.assertEquals(expectedXml, generateSureXml(extractor));
        Assertions.assertTrue(extractor.getProbableAuthors().isEmpty());
    ...
    @Test
    void youtubeWatchAiExplainedIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=kTslCsPBGHw";
        final String expectedXml = """
    ...
    @Test
    void youtubeWatchAINewsStrategyDailyIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=2uC5WllehxY";
        final String expectedXml = """
    ...
    @Test
    void youtubeWatchApresLaBiereIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=vOOxi9MfgNE";
        final String expectedXml = """
    ...
    void youtubeWatchBlackPenRedPenIsManaged() throws ContentParserException {
        ...
        final String expectedXml = """
                <ARTICLE><X><T>Solving a homemade triple exponential equation</T>\
    ...
    @Test
    void youtubeWatchChalkTalkIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=8JuWdXrCmWg";
        final String expectedXml = """
    ...
    @Test
    void youtubeWatchCarberraIsManaged() throws ContentParserException {
    ...
    @Test
    void youtubeWatchDaveEbbelaarIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=p4G0coRey9w";
        final String expectedXml = """
    ...
    @Test
    void youtubeWatchComputerfileLewisStuartIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=nOCPpT-Sn0A";
        final String expectedSureXml = """
    ...
    @Test
    void youtubeWatchEricRowlandIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=HcGjCcLEgN4";
        final String expectedXml = """
                <ARTICLE><X><T>The Hidden Structure of Rule 30</T>\
                <A>https://www.youtube.com/watch?v=HcGjCcLEgN4</A>\
                <L>en</L><F>MP4</F><DURATION><MINUTE>29</MINUTE><SECOND>5</SECOND></DURATION>\
                </X><AUTHOR><FIRSTNAME>Eric</FIRSTNAME><LASTNAME>Rowland</LASTNAME></AUTHOR>\
    ...
    @Test
    void youtubeWatchEvoSapiensIsManaged() throws ContentParserException {
    ...
    @Test
    void youtubeWatchGitButlerCalebIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=MPFgOnACULU";
        final String expectedSureXml = """
    ...
    @Test
    void youtubeWatchGitButlerEstebanIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=d6QfN6pKPAk";
        final String expectedSureXml = """
    ...
    @Test
    void youtubeWatchGrantSandersonIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=KJtZARuO3JY";
        final String expectedXml = """
    ...
    @Test
    void youtubeWatchJillesIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=qnIu-Xu64H0";
        final String expectedXml = """
                <ARTICLE><X><T>Herdr in about 6 minutes</T>\
                <A>https://www.youtube.com/watch?v=qnIu-Xu64H0</A>\
                <L>en</L><F>MP4</F><DURATION><MINUTE>6</MINUTE><SECOND>37</SECOND></DURATION></X>\
                <AUTHOR><FIRSTNAME>Jilles</FIRSTNAME><LASTNAME>Soeters</LASTNAME></AUTHOR>\
                <DATE><YEAR>2026</YEAR><MONTH>6</MONTH><DAY>29</DAY></DATE>\
                <COMMENT>XXXXX</COMMENT></ARTICLE>""";
        final LinkDataExtractor extractor = getExtractor(url);
        Assertions.assertEquals(expectedXml, generateSureXml(extractor));
        Assertions.assertTrue(extractor.getProbableAuthors().isEmpty());
    ...
    @Test
    void youtubeWatchKyleCookFromWebDevSimplifiedIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=jnsuwGElcig";
        final String expectedXml = """
                <ARTICLE><X><T>Stop Wasting Your Time On YouTube</T>\
                <A>https://www.youtube.com/watch?v=jnsuwGElcig</A>\
                <L>en</L><F>MP4</F><DURATION><MINUTE>9</MINUTE><SECOND>52</SECOND></DURATION></X>\
                <AUTHOR><FIRSTNAME>Kyle</FIRSTNAME><LASTNAME>Cook</LASTNAME></AUTHOR>\
                <DATE><YEAR>2026</YEAR><MONTH>4</MONTH><DAY>11</DAY></DATE>\
                <COMMENT>XXXXX</COMMENT></ARTICLE>""";
        final LinkDataExtractor extractor = getExtractor(url);
        Assertions.assertEquals(expectedXml, generateSureXml(extractor));
        Assertions.assertTrue(extractor.getProbableAuthors().isEmpty());
    ...
    @Test
    void youtubeWatchLaGuildeExpertiseEnQualityEngineeringIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=8Xjsm4kTAV8";
        final String expectedXml = """
    ...
    @Test
    void youtubeWatchMathsdropIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=X2JBKUwwuN8";
        final String expectedXml = """
    ...
    @Test
    void youtubeWatchMichaelLaunayMicmathsIsManaged() throws ContentParserException {
    ...
    @Test
    void youtubeWatchModernSoftwareEngineeringWithDaveFarleyIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=b9EbCb5A408";
        final String expectedSureXml = """
                <ARTICLE><X><T>We Studied 150 Developers Using AI (Here’s What's Actually Changed...)</T>\
                <A>https://www.youtube.com/watch?v=b9EbCb5A408</A>\
                <L>en</L><F>MP4</F><DURATION><MINUTE>11</MINUTE><SECOND>55</SECOND></DURATION></X>\
                <DATE><YEAR>2026</YEAR><MONTH>1</MONTH><DAY>27</DAY></DATE>\
                <COMMENT>XXXXX</COMMENT></ARTICLE>""";
        final String expectedProbableXml = """
                <ARTICLE><X><T>We Studied 150 Developers Using AI (Here’s What's Actually Changed...)</T>\
                <A>https://www.youtube.com/watch?v=b9EbCb5A408</A>\
    ...
    @Test
    void youtubeWatchModernSoftwareEngineeringWithKenBeckTrishaGeeIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=lJiDBRh96oU";
        final String expectedSureXml = """
    ...
    @Test
    void youtubeWatchNumberphileRobEastawayIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=ERAgUg-e_Qs";
        final String expectedSureXml = """
    ...
    @Test
    void youtubeWatchNumberphileZvezdelinaStankovaIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=XhA5U9pFXuU";
        final String expectedSureXml = """
    ...
    @Test
    void youtubeWatchNumberphile2MattParkerIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=oE8puWQ4taQ";
        final String expectedSureXml = """
    ...
    @Test
    void youtubeWatchPhysicsGirlIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=B3m3AMRlYfc";
        final String expectedXml = """
    ...
    @Test
    void youtubeWatchSciShowHankGreenIsManaged() throws ContentParserException {
    ...
    @Test
    void youtubeWatchSciShowJaidaElcockIsManaged() throws ContentParserException {
    ...
    @Test
    void youtubeWatchSciShowNibaIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=Kki11f_SpKs";
        final String expectedSureXml = """
    ...
    @Test
    void youtubeWatchSciShowStefanChinIsManaged() throws ContentParserException {
    ...
    @Test
    void youtubeWatchSebastianRaschkaIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=rNlULI-zGcw";
        final String expectedXml = """
    ...
    @Test
    void youtubeWatchSimonWillisonIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=9o1_DL9uNlM";
        final String expectedXml = """
    ...
    @Test
    void youtubeWatchSmarterEveryDayIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=v0afQ6w3Bjw";
        final String expectedXml = """
                <ARTICLE><X><T>Refueling a NUCLEAR REACTOR - Smarter Every Day 311</T>\
                <A>https://www.youtube.com/watch?v=v0afQ6w3Bjw</A>\
                <L>en</L><F>MP4</F><DURATION><HOUR>1</HOUR><MINUTE>46</MINUTE><SECOND>8</SECOND></DURATION></X>\
                <AUTHOR><FIRSTNAME>Destin</FIRSTNAME><LASTNAME>Sandlin</LASTNAME></AUTHOR>\
                <DATE><YEAR>2025</YEAR><MONTH>11</MONTH><DAY>3</DAY>\
                </DATE><COMMENT>XXXXX</COMMENT></ARTICLE>""";
        final LinkDataExtractor extractor = getExtractor(url);
        Assertions.assertEquals(expectedXml, generateSureXml(extractor));
        Assertions.assertTrue(extractor.getProbableAuthors().isEmpty());
    ...
    @Test
    void youtubeWatchTheMadPodcastWithMattTurckIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=9MEJ4syOVrQ";
        final String expectedXml = """
                <ARTICLE><X><T>Anthropic’s Felix Rieseberg: Claude Cowork, Mythos, and the SaaS Extinction</T>\
                <A>https://www.youtube.com/watch?v=9MEJ4syOVrQ</A>\
                <L>en</L><F>MP4</F><DURATION><MINUTE>58</MINUTE><SECOND>8</SECOND></DURATION></X>\
                <AUTHOR><FIRSTNAME>Matt</FIRSTNAME><LASTNAME>Turck</LASTNAME></AUTHOR>\
                <DATE><YEAR>2026</YEAR><MONTH>4</MONTH><DAY>10</DAY></DATE>\
                <COMMENT>XXXXX</COMMENT></ARTICLE>""";
        final LinkDataExtractor extractor = getExtractor(url);
        Assertions.assertEquals(expectedXml, generateSureXml(extractor));
        Assertions.assertTrue(extractor.getProbableAuthors().isEmpty());
    ...
    @Test
    void youtubeWatchUpAndAtomIsManaged() throws ContentParserException {
        final String url = "https://www.youtube.com/watch?v=yrJA0J7jciY";
        final String expectedXml = """
